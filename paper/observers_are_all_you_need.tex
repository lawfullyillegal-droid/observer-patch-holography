...
is shape-accurate with one reduced normalization invariant open, and the charged-lepton, quark,
...
and the charged-lepton, quark, neutrino, and hadron lanes carry named remaining closure objects;
at the local numerical level the same calibrated input \(P\) already organizes the bosonic mass
