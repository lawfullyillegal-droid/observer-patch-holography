...
### Concrete UV realization: quantum link models
...
### Conformal-modular fixed point microphysics (CMFP)
...
### Theorem: $\mathrm{BW}_{S^2}$ from Markov locality, symmetry, regularity
...
### Theorem: $\mathrm{BW}_{S^2}$ implies Lorentz kinematics
...
### Modular energy as stress-tensor charge (UV CFT)
...
### Entanglement equilibrium from MaxEnt
...
### Einstein equation from cap equilibrium
...
### Focusing/QNEC internalization via relative entropy
...
### Discrete horizon area spectrum and Hawking emission (speculative)
...
### Dark matter as modular anomaly (program-level)
...
### Selecting the SM factors (derived from MAR)
...
### Generation number from CP violation and refinement stability (derived from MAR)
...
### Mass predictions from symmetry
...
### Particle mass extraction from spectroscopy
