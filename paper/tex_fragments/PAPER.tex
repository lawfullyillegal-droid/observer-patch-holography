...
\item \textbf{Neutrino data}: beyond the input-dependent, order-of-magnitude capacity estimate tied to $N_{\mathrm{scr}}$, the recovered core does not derive neutrino masses or mixings. A later continuation branch does emit intrinsic masses, splittings, and PMNS data, but its current branch is quantitatively wrong and therefore not yet promotable.
