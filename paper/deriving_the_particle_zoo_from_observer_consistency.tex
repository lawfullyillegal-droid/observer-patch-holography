...
Electroweak calibration & \(W\) boson & calibration & \(80.37700001539531~\mathrm{GeV}\) from the target-free source-only repair theorem & no open D10 mass-side blocker; freeze-once surface retained only as validation \\
Electroweak calibration & \(Z\) boson & calibration & \(91.18797807794321~\mathrm{GeV}\) from the target-free source-only repair theorem & same closed target-free electroweak theorem as the \(W\) row \\
